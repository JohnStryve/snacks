...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_firebase___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__common_firebase__);
...
// });
// feature_overlay();
}function createDropzones(){$('[dz-alter]').click(function(){$('[dz]').click()});var home=this;var dz_configs={url:'/file/post',maxFilesize:10,maxFiles:20,addRemoveLinks:true,dictResponseError:'Server not Configured',acceptedFiles:'.png,.jpg,.gif,.bmp,.jpeg',// previewTemplate: $('.prevv').html(),
